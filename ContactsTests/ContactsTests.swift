...
//    
//    func initStubs() {
//        let phoneNumbers: [PhoneModel] = [ PhoneModel(name: "9008893255", phoneType: "home"),
//                                         PhoneModel(name: "8147823061", phoneType: "work") ]
//        let emailAddresses: [EmailModel] = [ EmailModel(email: "amankohli1993@gmail.com", emailType: "home"),
//                                            EmailModel(email: "akhilesh18992@gmail.com", emailType: "work") ]
//        let photo = UIImageJPEGRepresentation(#imageLiteral(resourceName: "profilePlaceholder"), 1)
//        insertContact(firstName: "Aman",
//                      lastName: "Singh",
//                      company: "DriveU",
//                      phoneNumbers: phoneNumbers,
//                      emailAddresses: emailAddresses,
//                      photo: photo)
//        insertContact(firstName: "Akhilesh",
//                      lastName: "Singh",
//                      company: "US",
//                      phoneNumbers: phoneNumbers,
//                      emailAddresses: emailAddresses,
...
//        contactModel.firstName = "Amanpreet"
//        contactModel.lastName = "Singh"
//        contactModel.company = "Humble Mobile Solutions Pvt. Ltd."
//        let phoneNumbers: [PhoneModel] = [ PhoneModel(name: "9008893255", phoneType: "home"),
//                                           PhoneModel(name: "8147823061", phoneType: "work") ]
//        let emailAddresses: [EmailModel] = [ EmailModel(email: "amankohli1993@gmail.com", emailType: "home"),
//                                             EmailModel(email: "akhilesh18992@gmail.com", emailType: "work") ]
...
//        XCTAssertEqual(firstName, "Aman")
//        XCTAssertEqual(lastName, "Akhilesh")
//    }
//    
